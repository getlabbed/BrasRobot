...
//void doJoystickAxisMotion(SDL_JoyButtonEvent *event) //a voir si l'on veut avoir le up and down
...

{
    ...
    { // j'ai enlever le event axis 0 et 1 et 2 et ajouter le axis 4
        if(event->axis == 3)
        {
...
void doInput(void) // fonction principale qui s'execute lors du début du programme
{
    SDL_Event event;
...
void initSDL(void) // initialisation
{
    int i;
